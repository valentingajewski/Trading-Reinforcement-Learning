...
| `--ent-coef-final` | `0.001` | Preserves more late-stage exploration | Faster convergence toward deterministic policy |
| `--trade-penalty` | `1.25` | Stronger discouragement of trading, lower churn, can undertrade | More willingness to trade, can increase churn |
...
| `--min-hold-steps` | `30` | Forces longer holds, reduces micro-churn but slows reaction | Allows faster position changes, can overtrade |
...
| `ent_coef_final` | `0.001` | Maintains more late-stage stochasticity | Quicker convergence to lower exploration |
...
| `trade_penalty` | `1.25` | Fewer trades, lower churn, potential undertrading | More trades, higher churn risk |
...
| `min_hold_steps` | `30` | Forces commitment to positions, lower churn | Enables rapid switching |
...
- `initial_lr=5e-5`, `final_lr=5e-5`, `n_steps=4096`, `ent_coef=0.01 -> 0.001`
- `lstm_hidden_size=64`, `n_lstm_layers=2`
- `trade_penalty=1.25`, `whipsaw_window=30`, `whipsaw_penalty=1.75`
- `position_cost=0.002`, `min_hold_steps=30`, `drawdown_penalty=1.0`, `turnover_penalty=0.25`
